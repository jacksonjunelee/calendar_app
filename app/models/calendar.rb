...
#     cal = Google::Calendar.new(:client_id     => ENV["GOOGLE_CLIENT"],
#                                :client_secret => ENV["GOOGLE_SECRET_CLIENT"],
#                                :calendar      => "jjlee5266@gmail.com",
#                                :redirect_url  => "http://localhost:3000/auth/google_oauth2/callback" # this is what Google uses for 'applications'
#                                )
#
